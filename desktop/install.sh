...
# Pacman packages
sudo pacman -S --noconfirm rsync gvim git firefox networkmanager network-manager-applet i3lock i3status feh pasystray acpilight playerctl rsync noto-fonts flameshot dmenu pavucontrol blueman bluez
