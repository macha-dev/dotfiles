...
# Pacman packages
sudo pacman -S --noconfirm i3-wm rsync gvim git firefox networkmanager network-manager-applet i3lock i3status feh pasystray acpilight playerctl rsync noto-fonts flameshot dmenu pavucontrol blueman bluez
